...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/kctrl-registry/{hwId}": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "device hwId (mac-style or vendor serial)",
                        "name": "hwId",
                        "in": "path",
                        "required": true
                    },
                    ...
                    {
                        "description": "accepted fields whitelist: orgId, approved, approvedAt, approvedBy",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/system/kctrlRegistryDrift": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "stale window in seconds (default 3600)",
                        "name": "staleSecs",
                        "in": "query"
                    }
                ],
        ...
        "/admin/system/kctrlRegistryRetry/{hwId}": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
