    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/atapi.ATASyncResponse"
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authzmod.PermissionCheckRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/authz/permission/check/batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Batch permission check requests",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/authz/profiles/{code}/publish": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Publish profile payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authzmod.PublishProfileRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/authz/relationships": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal Server Error – failed to call Permify",
                        "schema": {
                            "$ref": "#/definitions/gmod.ErrorMessageResponse"
                        }
                    }
        ...
        "/authz/resource/grant": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Grant resource permission payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authzmod.GrantResourceRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Resource granted successfully",
                        "schema": {
                            "$ref": "#/definitions/gmod.SuccessMessageResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Internal error from Permify",
                        "schema": {
                            "$ref": "#/definitions/gmod.ErrorMessageResponse"
                        }
                    }
        ...
        "/authz/resource/revoke": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Revoke grant resource permission payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authzmod.RevokeResourceRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Resource revoke granted successfully",
                        "schema": {
                            "$ref": "#/definitions/gmod.SuccessMessageResponse"
                        }
                    },
        ...
        "/authz/schema/apply": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Schema applied \u0026 relationships synced successfully",
                        "schema": {
                            "$ref": "#/definitions/gmod.SuccessMessageResponse"
                        }
                    },
        ...
        "/authz/tuples/factoryResetTenant": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authzmod.FactoryForceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users": {
            "get": {
                ...
                "description": "Get list of users from Keycloak",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "username",
                        "description": "Sort field: username|email|firstName|lastName",
                        "name": "sortField",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "atapi.ATASyncResponse": {
            ...
            "properties": {
                ...
                "detail": {
                    "$ref": "#/definitions/atasvc.SyncResult"
                },
                "message": {
                    "type": "string",
        ...
        "authzmod.GrantResourceRequest": {
            "type": "object",
            "properties": {
                "assignedGroupId": {
                    "description": "→ relation: assigned_group",
                    "type": "string"
                },
                "assignedRoleId": {
                    "description": "→ relation: assigned_role",
                    "type": "string"
                },
                "crud": {
                    "description": "เช่น \"c\", \"cru\", \"crd\", ใช้ใน attribute:crud",
                    "type": "string"
                },
                "editorUserIds": {
                    "description": "→ relation: editor",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "authzmod.PermissionCheckRequest": {
            "type": "object",
            "required": [
                "entity",
                "metadata",
            ...
            "properties": {
                ...
                "subject": {
                    ...
                    "properties": {
                        ...
                        "type": {
                            "description": "เช่น \"user\", \"group\", \"role\"",
                            "type": "string"
                        }
                    }
                }
        ...
        "authzmod.PublishItem": {
            "type": "object",
            "properties": {
                "crud": {
                    "description": "[\"c\",\"r\",\"u\",\"d\"] หรือ [\"read\",\"update\",...]",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "relationship": {
                    "description": "รูปแบบ subject ตรง ๆ เช่น \"role:PF_OFFICE\" หรือ \"group:g_inno\"\n(ใช้แทน subjectType+subjectId แบบใหม่)",
                    "type": "string"
                },
                "resourceId": {
                    "description": "รหัส resource เช่น \"menu_dashboard_global\", \"device:xxx\"",
                    "type": "string"
                },
                "subjectId": {
                    "type": "string"
                ...
                "subjectType": {
                    "description": "รองรับ legacy payload แบบเก่า",
                    "type": "string"
                }
            }
        },
        "authzmod.PublishProfileRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/authzmod.PublishItem"
                    }
                },
                "note": {
                    "type": "string"
        ...
        "authzmod.RevokeResourceRequest": {
            "type": "object",
            "properties": {
                "entityIds": {
                    "type": "array",
